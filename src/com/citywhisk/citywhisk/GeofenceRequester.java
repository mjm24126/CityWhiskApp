...
//                    Arrays.toString(geofenceRequestIds));
            ...
            broadcastIntent.setAction(GeofenceUtils.ACTION_GEOFENCES_ADDED)
                           ...
                           .putExtra(GeofenceUtils.EXTRA_GEOFENCE_STATUS, "success");
...
//            );
            ...
            // Log an error
            //Log.e(GeofenceUtils.APPTAG, "failure");

            // Create an Intent to broadcast to the app
            broadcastIntent.setAction(GeofenceUtils.ACTION_GEOFENCE_ERROR)
                           .addCategory(GeofenceUtils.CATEGORY_LOCATION_SERVICES)
                           .putExtra(GeofenceUtils.EXTRA_GEOFENCE_STATUS, "failure");
        }
    ...
    public void onConnected(Bundle arg0) {
        ...
        //Log.d(GeofenceUtils.APPTAG, "connected");
    ...
    public void onDisconnected() {
        ...
        //Log.d(GeofenceUtils.APPTAG, "disconnected");
